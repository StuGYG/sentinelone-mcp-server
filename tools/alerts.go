...
var listAlertsTool = mcp.NewTool("s1_list_alerts",
	...
	mcp.WithString("analystVerdict",
		mcp.Description("Filter by analyst verdict: TruePositive, FalsePositive, Suspicious, Undefined"),
	),
	mcp.WithString("incidentStatus",
		mcp.Description("Filter by incident status: Unresolved, InProgress, Resolved"),
	),
